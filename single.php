	  ...
	  $(document).ready(function(){
		  ...
		  function createTremula(){
		    ...
		    var config = {
		      ...
		      //enables looping with the current set of results
		      isLooping         	:false,
	...
	<div id="secondary" class="content-area">
		...
		while ( have_posts() ) : the_post();
			...
			the_post_navigation( array(
				'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'celandone' ) . '</span> ' .
					'<span class="screen-reader-text">' . __( 'Next post:', 'celandone' ) . '</span> ' .
					'<span class="post-title">%title</span>',
				'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'celandone' ) . '</span> ' .
					'<span class="screen-reader-text">' . __( 'Previous post:', 'celandone' ) . '</span> ' .
					'<span class="post-title">%title</span>',
			) );
