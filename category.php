...
get_header(); ?>
	  ...
	  $(document).ready(function(){
		  ...
		  function createTremula(){
		    ...
		    var config = {
		      ...
		      itemMargins         :[35,35],//x (left & right), y (top & bottom) in px
		      ...
		      // (x) enterTheDragon
		      //----------------------
		      surfaceMap          :tremula.projections.turntable,
		  ...
		  */
		  var pageCtr = 1;
		  function loadFlickr(){
		    var dataUrl = "http://art.celand.nl/?json=get_category_posts&include=url,title,thumbnail,categories&count=40&slug=art";
		    $.ajax({
		      url:dataUrl
		      ,dataType: 'jsonp'
		      ,jsonp: 'callback' 
		  ...
		  */
		  ...
		  function flickrDataAdapter(data,env){
		    ...
		    this.template2 = this.data.template||('<img draggable="false" class="moneyShot" onload="imageLoaded(this)" src=""/>');
	...
	<div id="primary" class="content-area">
		 <div class="pageLayoutContainer">
			...
			<div class="tremulaContainer" style="-webkit-perspective: 3500;"></div>
